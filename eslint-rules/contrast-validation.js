...
const DANGEROUS_COMBINATIONS = [
  ...
  { bg: /bg-white|bg-neutral-50|bg-neutral-100/, text: /text-white|text-neutral-50|text-neutral-100/ },
  
  // Dark text on dark backgrounds  
  { bg: /bg-neutral-800|bg-neutral-900|bg-black/, text: /text-neutral-800|text-neutral-900|text-black/ },
  
  // Light colors on light backgrounds
  { bg: /bg-yellow-[123]00|bg-orange-[123]00/, text: /text-white|text-yellow-[123]00/ },
...
const SAFE_COMBINATIONS = {
  'bg-white': ['text-neutral-700', 'text-neutral-800', 'text-neutral-900', 'text-primary-700', 'text-primary-800', 'text-primary-900'],
  'bg-neutral-50': ['text-neutral-700', 'text-neutral-800', 'text-neutral-900', 'text-primary-700', 'text-primary-800', 'text-primary-900'],
  'bg-neutral-100': ['text-neutral-700', 'text-neutral-800', 'text-neutral-900', 'text-primary-700', 'text-primary-800', 'text-primary-900'],
...
module.exports = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Prevent dangerous color combinations that result in unreadable text',
        ...
        if (node.value) {
          if (node.value.type === 'Literal') {
            ...
            if (expr.type === 'Literal') {
              ...
              classValue = expr.quasis.map(quasi => quasi.value.cooked).join(' ');
