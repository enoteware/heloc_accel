...
async function testCalculator() {
  ...
  try {
    ...
    // Take a screenshot
    await page.screenshot({ path: '/Users/elliotnoteware/Documents/heloc_accel/heloc-accelerator/calculator-screenshot.png' });
    ...
    const homeValueInput = await page.$('input[name="homeValue"], input[id*="home"], input[placeholder*="home" i]');
    if (homeValueInput) {
