        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-2 text-sm text-gray-600">
            <p>
              ...
              results are estimates based on the information you provide and
            ...
            <div className="mt-3 space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>
                  Actual results may vary based on your specific financial
                  situation
                </li>
                <li>
                  The HELOC acceleration strategy involves risks including
                  potential loss of home equity
                </li>
                <li>
                  This strategy requires disciplined financial management and
                  positive cash flow
                </li>
                <li>
              ...
              <p className="mt-2">
                <strong>
                  ...
                  advisor, tax professional, and mortgage specialist before
                  making any decisions about mortgage acceleration strategies.
                </strong>
              </p>
            </div>
          </div>
