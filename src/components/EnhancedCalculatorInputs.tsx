...
import { formatNumberWithCommas, parseFormattedNumber } from '@/lib/number-formatting';
...
interface EnhancedInputProps {
  ...
  value: string | number;
  error?: string;
  onChange: (field: keyof CalculatorValidationInput, value: string | number) => void;
...
export const EnhancedCurrencyInput: React.FC<EnhancedInputProps> = ({
  ...
  const labelClasses = priority === 'high' 
    ? 'text-lg font-semibold text-gray-800 mb-1.5' 
    : 'text-sm font-medium text-gray-700 mb-1';

  const inputClasses = priority === 'high'
