...
const THEME_IMAGES = {
  home: {
    background: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1200&q=80",
    hover: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?auto=format&fit=crop&w=1200&q=80"
  },
  money: {
    background: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=1200&q=80",
    hover: "https://images.unsplash.com/photo-1640340434855-6084b1f4901c?auto=format&fit=crop&w=1200&q=80"
  },
  success: {
    background: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=1200&q=80",
    hover: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=80"
  },
  planning: {
    background: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80",
    hover: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1200&q=80"
  },
  family: {
    background: "https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&w=1200&q=80",
    hover: "https://images.unsplash.com/photo-1609220136736-443140cffec6?auto=format&fit=crop&w=1200&q=80"
  }
};
...
export function StableHomeCard(props: Omit<StableAceternityCardProps, 'theme'>) {
  return <StableAceternityCard theme="home" {...props} />;
}

export function StableMoneyCard(props: Omit<StableAceternityCardProps, 'theme'>) {
  return <StableAceternityCard theme="money" {...props} />;
}

export function StableSuccessCard(props: Omit<StableAceternityCardProps, 'theme'>) {
  return <StableAceternityCard theme="success" {...props} />;
}

export function StablePlanningCard(props: Omit<StableAceternityCardProps, 'theme'>) {
  return <StableAceternityCard theme="planning" {...props} />;
}

export function StableFamilyCard(props: Omit<StableAceternityCardProps, 'theme'>) {
