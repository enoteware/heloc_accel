...
export interface SimpleAceternityCardProps {
  title?: string;
  description?: string;
...
export default function SimpleAceternityCard({
  ...
  return (
    <div className={cn("max-w-xs w-full", className)}>
      <div
        ...
        style={{
          backgroundImage: `url(${isHovered ? hoverImage : backgroundImage})`,
        }}
...
export function SimpleAceternityCardDemo() {
  return <SimpleAceternityCard />;
}
