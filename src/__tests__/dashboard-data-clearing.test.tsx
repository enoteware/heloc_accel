...
const mockGetDemoScenarios = jest.mocked(require('@/lib/demo-storage').getDemoScenarios)
const mockClearDemoScenarios = jest.mocked(require('@/lib/demo-storage').clearDemoScenarios)
const mockGenerateSampleScenarios = jest.mocked(require('@/lib/demo-storage').generateSampleScenarios)
const mockGetStorageInfo = jest.mocked(require('@/lib/demo-storage').getStorageInfo)

// Mock confirmation modals
jest.mock('@/components/ConfirmationModals', () => ({
  FirstConfirmationModal: ({ isOpen, onClose, onConfirm, title, message }: any) =>
    isOpen ? (
  ...
  SuccessModal: ({ isOpen, onClose, onRegenerateData, showRegenerateOption }: any) =>
    isOpen ? (
...
describe('Dashboard Data Clearing Integration', () => {
  ...
  it('should show storage warning when localStorage is not available', async () => {
    ...
    expect(screen.getByText('localStorage is not available in this browser')).toBeInTheDocument()
  })
  ...
  it('should handle cancellation at first confirmation', async () => {
    ...
    expect(screen.queryByTestId('first-confirmation-modal')).not.toBeInTheDocument()
  ...
  it('should handle cancellation at second confirmation', async () => {
    ...
    // Modal should close and no clearing should happen
    expect(screen.queryByTestId('second-confirmation-modal')).not.toBeInTheDocument()
    expect(mockClearDemoScenarios).not.toHaveBeenCalled()
  })
