...
describe('Color Contrast Integration Tests', () => {
  it('should validate design system colors meet WCAG standards', () => {
    ...
    const primaryResult = validateTailwindCombination('bg-primary-500 text-white');
    expect(primaryResult.isValid).toBe(true);
    
    // Test secondary button combinations  
    const secondaryResult = validateTailwindCombination('bg-secondary-500 text-white');
    expect(secondaryResult.isValid).toBe(true);
    
    // Test neutral combinations
    const lightResult = validateTailwindCombination('bg-white text-neutral-900');
...
describe('Screen Reader Tests', () => {
  it('should provide proper labels for interactive elements', () => {
    ...
    const helpLink = screen.getByLabelText('Get help with using the calculator');
  ...
  it('should have visible focus indicators', () => {
    render(
      <div>
        ...
        <a href="/test" className="safe-link">Test Link</a>
      </div>
    );
