...
export type NeutralColors = 
  | 'white' | 'neutral-50' | 'neutral-100' | 'neutral-200' | 'neutral-300' | 'neutral-400'
  | 'neutral-500' | 'neutral-600' | 'neutral-700' | 'neutral-800' | 'neutral-900' | 'black';

export type StatusColors = 
  | 'red-50' | 'red-100' | 'red-500' | 'red-600' | 'red-800'
  | 'green-50' | 'green-100' | 'green-500' | 'green-600' | 'green-800'
  | 'blue-50' | 'blue-100' | 'blue-500' | 'blue-600' | 'blue-800'
  | 'yellow-50' | 'yellow-100' | 'yellow-400' | 'yellow-500' | 'yellow-800';

export type AllColors = PrimaryColors | SecondaryColors | NeutralColors | StatusColors;

// Background color types
export type LightBackgrounds = 
  | 'white' | 'neutral-50' | 'neutral-100' | 'primary-50' | 'primary-100' 
  | 'secondary-50' | 'secondary-100' | 'red-50' | 'green-50' | 'blue-50' | 'yellow-50';

export type DarkBackgrounds = 
  | 'neutral-800' | 'neutral-900' | 'black' | 'primary-700' | 'primary-800' | 'primary-900'
  | 'secondary-700' | 'secondary-800' | 'secondary-900';

export type MediumBackgrounds = 
  | 'primary-500' | 'primary-600' | 'secondary-500' | 'secondary-600'
  | 'red-500' | 'red-600' | 'green-500' | 'green-600' | 'blue-500' | 'blue-600';

// Safe text colors for each background type
export type SafeTextForLight = 
  | 'neutral-700' | 'neutral-800' | 'neutral-900' | 'black'
  | 'primary-700' | 'primary-800' | 'primary-900'
  | 'secondary-700' | 'secondary-800' | 'secondary-900'
  | 'red-800' | 'green-800' | 'blue-800' | 'yellow-800';

export type SafeTextForDark = 
  | 'white' | 'neutral-50' | 'neutral-100' | 'neutral-200';

export type SafeTextForMedium = 
  | 'white' | 'neutral-50';

// Conditional type for safe text colors based on background
export type SafeTextColor<T extends AllColors> = 
  T extends LightBackgrounds ? SafeTextForLight :
  T extends DarkBackgrounds ? SafeTextForDark :
  T extends MediumBackgrounds ? SafeTextForMedium :
  never;
...
export interface StrictContrastProps {
  ...
  variant: SafeButtonVariant | SafeAlertVariant | SafeBadgeVariant | SafeCardVariant;
...
export const SAFE_BACKGROUNDS = [
  'white', 'neutral-50', 'neutral-100', 'neutral-800', 'neutral-900',
  'primary-50', 'primary-100', 'primary-500', 'primary-600', 'primary-700', 'primary-800', 'primary-900',
  'secondary-50', 'secondary-100', 'secondary-500', 'secondary-600', 'secondary-700', 'secondary-800', 'secondary-900',
  'red-50', 'red-100', 'red-500', 'red-600',
  'green-50', 'green-100', 'green-500', 'green-600',
  'blue-50', 'blue-100', 'blue-500', 'blue-600',
  'yellow-50', 'yellow-100', 'yellow-400'
] as const;

export const SAFE_TEXT_COLORS = [
  'white', 'neutral-50', 'neutral-100', 'neutral-700', 'neutral-800', 'neutral-900', 'black',
  'primary-700', 'primary-800', 'primary-900',
  'secondary-700', 'secondary-800', 'secondary-900',
  'red-800', 'green-800', 'blue-800', 'yellow-800'
] as const;
...
export const isLightBackground = (color: string): color is LightBackgrounds => {
  return ['white', 'neutral-50', 'neutral-100', 'primary-50', 'primary-100', 
          'secondary-50', 'secondary-100', 'red-50', 'green-50', 'blue-50', 'yellow-50'].includes(color);
};

export const isDarkBackground = (color: string): color is DarkBackgrounds => {
  return ['neutral-800', 'neutral-900', 'black', 'primary-700', 'primary-800', 'primary-900',
          'secondary-700', 'secondary-800', 'secondary-900'].includes(color);
};

export const isMediumBackground = (color: string): color is MediumBackgrounds => {
  return ['primary-500', 'primary-600', 'secondary-500', 'secondary-600',
          'red-500', 'red-600', 'green-500', 'green-600', 'blue-500', 'blue-600'].includes(color);
};