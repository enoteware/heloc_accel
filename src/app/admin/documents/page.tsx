...
import { exportAgentsToCSV, exportAssignmentsToCSV, importAgentsFromCSV } from '@/lib/export-utils'
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Documents & Data Export</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Export all agent information including contact details and specialties
              </p>
              <button
      ...
      <div className="bg-white shadow rounded-lg mb-6">
        ...
        <div className="p-6">
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Upload a CSV file to bulk import agents. The CSV should include columns for:
              First Name, Last Name, Title, Email, Phone, etc.
            </p>
            <input
              ref={fileInputRef}
              type="file"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-3">
                <FileText className="h-5 w-5 text-gray-400" />
                <div>
                  <p className="font-medium text-gray-900">Agent Import Template</p>
                  <p className="text-sm text-gray-600">CSV template for bulk agent import</p>
                </div>
              </div>
              <button
                onClick={() => {
                  // Download template
                  const template = 'First Name,Last Name,Title,Email,Phone,Extension,Mobile,NMLS #,Licensed States,Specialties,Years Experience,Active,Bio\n' +
            ...
            <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Company privacy policy document</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Company terms and conditions</p>
                </div>
              </div>
              <button className="text-blue-600 hover:text-blue-700">
                Edit
            ...
            <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Required HELOC disclosure statement</p>
                </div>
              </div>
              <button className="text-blue-600 hover:text-blue-700">
                Edit
