...
function ComparePageContent() {
  ...
  }, [session, searchParams, loadScenarios]);
                      ...
                      <tr className="bg-gray-50">
                        ...
                        {selectedScenarioData.map((scenario) => (
                          <td
                            ...
                            className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"
                          >
                            {scenario.heloc_limit
                              ? formatCurrency(scenario.heloc_limit)
                              : "N/A"}
                          </td>
                        ))}
                      </tr>
                        ...
                        {selectedScenarioData.map((scenario) => (
                          ...
                          >
                            {scenario.traditional_payoff_months
                              ? formatMonths(scenario.traditional_payoff_months)
                              : "N/A"}
                          </td>
                        ))}
                      </tr>
                        ...
                        {selectedScenarioData.map((scenario) => (
                          ...
                          >
                            {scenario.time_saved_months
                              ? formatMonths(scenario.time_saved_months)
                              : "N/A"}
                          </td>
                        ))}
                      </tr>
