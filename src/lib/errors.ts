...
export const ERROR_MESSAGES: Record<ErrorCode, (params?: any) => ErrorDetails> =
  {
    [ErrorCode.VALIDATION_FAILED]: (params) => ({
      ...
      suggestion:
        "Review the highlighted fields and ensure all values are within acceptable ranges",
      ...params,
    }),
    ...
    [ErrorCode.INVALID_INTEREST_RATE]: (params) => ({
      ...
      suggestion:
        "Interest rates should be between 0.1% and 30%. For example, enter 6.5 for 6.5%",
      field: "interestRate",
      ...params,
    }),
    ...
    [ErrorCode.INVALID_PAYMENT]: (params) => ({
      ...
      suggestion:
        "Please enter a valid monthly payment amount. This should be a positive number representing your current monthly mortgage payment.",
    ...
    [ErrorCode.NEGATIVE_AMORTIZATION]: (params) => ({
      ...
      suggestion:
        "This would cause your loan balance to increase over time. Please check:\n• Your monthly payment amount\n• Your interest rate\n• Your remaining loan term",
      field: "monthlyPayment",
      ...params,
    }),
    ...
    [ErrorCode.HELOC_EXCEEDS_LIMIT]: (params) => ({
      ...
      userMessage:
        "The HELOC strategy would require more credit than available",
      suggestion:
    ...
    [ErrorCode.INSUFFICIENT_DISCRETIONARY]: (params) => ({
      ...
      userMessage:
        "Your discretionary income is too low for the HELOC acceleration strategy",
      suggestion:
    ...
    [ErrorCode.UNDERWATER_MORTGAGE]: (params) => ({
      ...
      suggestion:
        "This is common and doesn't prevent using the calculator. However, you may have limited HELOC options until you build more equity.",
      ...params,
    }),
    ...
    [ErrorCode.DATABASE_ERROR]: () => ({
      ...
      suggestion:
        "Please try again. If the problem persists, your data is safe in local storage.",
    }),
    ...
    [ErrorCode.AUTHENTICATION_REQUIRED]: () => ({
      ...
      suggestion:
        'You need to be logged in to use this feature. Click "Sign In" to continue.',
    }),
    ...
    [ErrorCode.RATE_LIMIT_EXCEEDED]: () => ({
      ...
      suggestion:
        "Please wait a moment before trying again. The limit resets every minute.",
    }),
    ...
    [ErrorCode.INVALID_CALCULATION_INPUT]: (params) => ({
      ...
      suggestion:
        "Please review your inputs and ensure all required fields are filled correctly.",
      field: params?.field,
      ...params,
    }),
  };
...
export function extractErrorDetails(error: unknown): ErrorDetails {
  ...
  if (error instanceof Error) {
    ...
    if (
      error.message.includes("Monthly payment") &&
      error.message.includes("less than monthly interest")
    ) {
