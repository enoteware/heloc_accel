...
export function validateContrast(
  ...
  if (!fg || !bg) {
    return {
      ...
      isAccessible: false,
      level: null,
      recommendation: 'Invalid color format. Use hex (#ffffff) or rgb(255, 255, 255) format.'
    };
  }
...
export const SAFE_COMBINATIONS: Record<string, string[]> = {
  ...
  // Neutral backgrounds
  'white': ['primary-700', 'primary-800', 'primary-900', 'neutral-700', 'neutral-800', 'neutral-900', 'secondary-700', 'secondary-800', 'secondary-900'],
  'neutral-50': ['primary-700', 'primary-800', 'primary-900', 'neutral-700', 'neutral-800', 'neutral-900', 'secondary-700', 'secondary-800', 'secondary-900'],
  'neutral-100': ['primary-700', 'primary-800', 'primary-900', 'neutral-700', 'neutral-800', 'neutral-900', 'secondary-700', 'secondary-800', 'secondary-900'],
  'neutral-200': ['primary-800', 'primary-900', 'neutral-800', 'neutral-900', 'secondary-800', 'secondary-900'],
