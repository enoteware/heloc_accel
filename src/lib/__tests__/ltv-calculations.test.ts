...
describe('LTV Calculation Functions', () => {
  describe('calculateLTV', () => {
    ...
    it('should throw CalculationError for null/undefined inputs', () => {
      ...
      expect(() => calculateLTV(400000, undefined as any)).toThrow(CalculationError)
    })

    it('should throw CalculationError for invalid number inputs', () => {
      expect(() => calculateLTV('invalid' as any, 500000)).toThrow(CalculationError)
      expect(() => calculateLTV(400000, 'invalid' as any)).toThrow(CalculationError)
    })
