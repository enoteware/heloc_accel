...
async function setupNeonDatabase() {
  console.log(
    "🚀 Setting up NEON PostgreSQL database for HELOC Accelerator...\n",
  );
  ...
  if (
    ...
    console.error(
      "❌ Error: DATABASE_URL not configured properly in .env.local",
    );
    console.log("\n📝 To fix this:");
    ...
    console.log(
      "4. Format: DATABASE_URL=postgresql://username:password@endpoint/database?sslmode=require\n",
    );
    process.exit(1);
  }
