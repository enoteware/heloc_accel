...
CREATE INDEX idx_scenario_agent_tracking_scenario_id ON scenario_agent_tracking(scenario_id);
CREATE INDEX idx_scenario_agent_tracking_agent_id ON scenario_agent_tracking(agent_id);
