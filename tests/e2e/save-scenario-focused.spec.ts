...
test.describe("Save Scenario Focused Test", () => {
  test("Test save scenario with results already showing", async ({ page }) => {
    ...
    await page.screenshot({
      path: "test-results/save-test-ready-state.png",
      fullPage: true,
    });
    ...
    if (!saveButton) {
      console.log(
        "❌ Save button not found. Let me check what buttons are available...",
      );
      ...
      await page.screenshot({
        path: "test-results/save-test-no-save-button.png",
        fullPage: true,
      });
    ...
    await page.screenshot({
      path: "test-results/save-test-after-click.png",
      fullPage: true,
    });
    ...
    if (modal) {
      ...
      await page.screenshot({
        path: "test-results/save-test-modal-filled.png",
        fullPage: true,
      });
      ...
      if (modalSaveButton) {
        ...
        await page.screenshot({
          path: "test-results/save-test-after-save.png",
          fullPage: true,
        });
        ...
        if (currentUrl.includes("/dashboard")) {
          ...
          await page.screenshot({
            path: "test-results/save-test-manual-dashboard.png",
            fullPage: true,
          });
          ...
          if ((await scenarioText.count()) > 0) {
            ...
            console.log(
              "❌ Scenario not found on manually navigated dashboard",
            );
          }
        }
      } else {
        ...
        await page.screenshot({
          path: "test-results/save-test-no-modal-save-btn.png",
          fullPage: true,
        });
      }
    } else {
      ...
      await page.screenshot({
        path: "test-results/save-test-no-modal.png",
        fullPage: true,
      });
    }
