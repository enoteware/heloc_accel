...
test.describe('Demo Account Full Feature Test', () => {
  ...
  test('2. Create and save new scenario', async ({ page }) => {
    ...
    await expect(page.locator('text=Scenario saved successfully')).toBeVisible({ timeout: 10000 });
  ...
  test('3. Load saved scenarios', async ({ page }) => {
    ...
    const scenarios = await page.locator('.scenario-card, [data-testid="scenario-item"]').count();
  ...
  test('4. Edit existing scenario', async ({ page }) => {
    ...
    await page.locator('.scenario-card, [data-testid="scenario-item"]').first().click();
    ...
    // Verify success
    await expect(page.locator('text=Scenario updated successfully, text=Scenario saved successfully')).toBeVisible({ timeout: 10000 });
  ...
  test('5. Delete scenario', async ({ page }) => {
    ...
    const beforeCount = await page.locator('.scenario-card, [data-testid="scenario-item"]').count();
    ...
    const afterCount = await page.locator('.scenario-card, [data-testid="scenario-item"]').count();
  ...
  test('7. Test calculator with real HELOC calculations', async ({ page }) => {
    ...
    await expect(page.locator('text=/Traditional.*months|HELOC.*months/i')).toBeVisible();
