...
test.describe('API Endpoints', () => {
  ...
  test('health endpoint should return proper structure', async ({ request }) => {
    const response = await request.get('/api/health');
    const data = await response.json();
  ...
  test('calculate endpoint should handle POST requests', async ({ request }) => {
    ...
    try {
      ...
      console.log('Calculate API not yet implemented or requires authentication');
    }
  });
