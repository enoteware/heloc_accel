...
test.describe('Home Page', () => {
  test('should load the home page successfully', async ({ page }) => {
    ...
    await expect(page.locator('text=Discover how a Home Equity Line of Credit')).toBeVisible();
  ...
  test('should have working Get Started button', async ({ page }) => {
    ...
    const getStartedButton = page.locator('button', { hasText: /Get Started|Try the Calculator|Calculate Your Savings/ });
  ...
  test('should display demo mode information when in demo mode', async ({ page }) => {
    // Set demo mode environment variable
    await page.addInitScript(() => {
      (window as any).process = { env: { NEXT_PUBLIC_DEMO_MODE: 'true', NODE_ENV: 'test' } };
    });
